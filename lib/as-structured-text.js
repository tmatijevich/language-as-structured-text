...
module.exports = {
  ...
  activate () {
    ...
    // Get auto uppercase setting
    const autoUppercase = atom.config.get("language-as-structured-text.autoCompleteUppercaseKeywords");
    // Add subscriptions
    if(autoUppercase) {this.subscriptions.add(
